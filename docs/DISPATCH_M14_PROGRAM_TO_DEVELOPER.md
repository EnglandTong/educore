# Dispatch - M14 Program To Developer

Status: Active
Issued by: MRT-Controller-QA
Issued at: 2026-06-20T08:49:58+08:00

## Authorization

Developer is authorized to execute the full M14 Program in order:

1. `docs/WORK_ORDER_P14-01.md`
2. `docs/WORK_ORDER_P14-02.md`
3. `docs/WORK_ORDER_P14-03.md`
4. `docs/WORK_ORDER_P14-04.md`
...
- Append loop evidence when applicable.
...
When all work orders are complete, Developer must create a consolidated M14 milestone handoff and set the state to `Developer Complete` or `Ready for Controller/QA Review`.

Developer must not mark M14 as `Accepted` or `Completed`. Only Controller/QA can sign acceptance.
